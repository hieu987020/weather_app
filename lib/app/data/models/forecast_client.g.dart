...
Forecast _$ForecastFromJson(Map<String, dynamic> json) => Forecast(
      channel: json['channel'] == null
          ? null
          : ForecastChannel.fromJson(json['channel'] as Map<String, dynamic>),
      feeds: (json['feeds'] as List<dynamic>?)
          ?.map((e) => ForecastFeed.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
...
class _ForecastObjectRestClient implements ForecastObjectRestClient {
